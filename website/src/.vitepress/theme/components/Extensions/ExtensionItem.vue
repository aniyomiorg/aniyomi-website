...
const pkgId = computed(() => {
	return item.value.pkg.replace("eu.kanade.tachiyomi.animeextension.", "")
})
...
const apkUrl = computed(() => {
	return `https://raw.githubusercontent.com/aniyomiorg/aniyomi-extensions/repo/apk/${item.value.apk}`
})
