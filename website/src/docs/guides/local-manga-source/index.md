...
1. Place correctly structured series inside `/Aniyomi/local/`.
...
Local series will be read from the `Aniyomi/local` folder.
...
<div class="tree">
	<ul>
		...
		<span class="folder root">/sdcard/Aniyomi/local</span>
		<li>
			<img src="/img/folder.svg" class="tree-icon icon-folder">
...
<div class="tree">
	<ul>
		<img src="/img/folder.svg" class="tree-icon icon-folder">
		<span class="folder root">/storage/18F5-2C11/Aniyomi/local</span>
		<li>
			<img src="/img/folder.svg" class="tree-icon icon-folder">
			<span class="folder main">[the series title]</span>
			<ul>
