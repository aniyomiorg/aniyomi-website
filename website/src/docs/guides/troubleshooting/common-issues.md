...
See [this](/docs/faq/android-11+) section of the FAQ to learn how Scoped Storage affects **Aniyomi** in **Android 11+** and how to fix it.
...
[Report the issue](https://github.com/aniyomiorg/aniyomi-extensions/issues/new/choose) to add rate limits and prevent future IP bans.
